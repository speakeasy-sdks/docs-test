...
// Cancel a prompt.
func (s *prompts) Cancel(ctx context.Context, request operations.CancelPromptRequest) (*operations.CancelPromptResponse, error) {
	baseURL := s.serverURL
...
func (s *prompts) Submit(ctx context.Context, request operations.SubmitPromptRequest) (*operations.SubmitPromptResponse, error) {
	baseURL := s.serverURL
